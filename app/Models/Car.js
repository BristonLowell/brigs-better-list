...
export default class Car {
  ...
  get Template() {
    ...
    <div class="card-body">
        ...
        <button class="btn btn-success btn-block mb-1" type="submit" >Bid</button>
        </form>
        <button class="btn btn-danger btn-block" onclick="app.carsController.delete('${this.id}')">Delete</button>
